        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div class="h-200">
                    ...
                    <canvas id="usersChart" width="236" height="160" class="chartjs-render-monitor" style="display: block; height: 200px; width: 295px;"></canvas>
                </div>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div class="h-200">
                    ...
                    <canvas id="bounceRateChart" width="236" height="160" class="chartjs-render-monitor" style="display: block; height: 200px; width: 295px;"></canvas>
                </div>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div class="h-200">
                    ...
                    <canvas id="sessionDuration" width="236" height="160" class="chartjs-render-monitor" style="display: block; height: 200px; width: 295px;"></canvas>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div id="recent-transaction-table_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="recent-transaction-table_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="recent-transaction-table"></label></div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-sm-12">
                        <table id="recent-transaction-table" class="table table-striped table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="recent-transaction-table_info">
                            <thead>
                                <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="recent-transaction-table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="TRANSACTION ID: activate to sort column descending" style="width: 100.008px;">TRANSACTION ID</th>
                                <th class="sorting" tabindex="0" aria-controls="recent-transaction-table" rowspan="1" colspan="1" aria-label="DATE: activate to sort column ascending" style="width: 41.0078px;">DATE</th>
                                <th class="sorting" tabindex="0" aria-controls="recent-transaction-table" rowspan="1" colspan="1" aria-label="AMOUNT: activate to sort column ascending" style="width: 61.0078px;">AMOUNT</th>
                                <th class="sorting" tabindex="0" aria-controls="recent-transaction-table" rowspan="1" colspan="1" aria-label="STATUS: activate to sort column ascending" style="width: 53.0078px;">STATUS</th>
                                <th class="no-sort sorting_disabled" rowspan="1" colspan="1" aria-label="RECEIPT" style="width: 57.0039px;">RECEIPT</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="dataTables_info" id="recent-transaction-table_info" role="status" aria-live="polite">Showing 1 to 10 of 24 entries</div>
                    </div>
                    <div class="col-sm-12 col-md-7">
                        <div class="dataTables_paginate paging_simple_numbers" id="recent-transaction-table_paginate">
                            <ul class="pagination">
                                <li class="paginate_button page-item previous disabled" id="recent-transaction-table_previous"><a href="#" aria-controls="recent-transaction-table" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>
