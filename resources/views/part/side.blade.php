                ...
                <!-- START LOGO -->
                    <a href="{{url('/')}}">
                        <div class="logo">
                            ...
                            <img src="http://test.pro/assets/img/ico.png" style="width=23px; height:23px; viewBox:0 0 54.03 56.55" alt="">
                        </div>
        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                ...
                <li class="nav-dropdown">
                    <a class="has" href="{{url('/admin')}}" aria-expanded="false"><i class="icon dripicons-meter"></i><span>Dashboard</span></a>
                </li>
                {{--  List Product  --}}
                <li class="sidebar-header"><span>Product Management</span></li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-article"></i><span>Category</span></a> 
                </li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-article"></i><span>Product</span></a> 
                </li>
                {{--  End List Product  --}}
                <li class="sidebar-header"><span>Other Management</span></li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-browser"></i><span>Manajemen User</span></a>
